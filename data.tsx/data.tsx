export const DashboardSvg: React.FC<{ className?: string }> = ({
  className,
}) => {
  return (
    <svg
...
export const OrderSvg: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <svg
      width="20"
      height="21"
...
export const Analytic: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <svg
      width="22"
      height="22"
...
export const Customers: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <svg
      width="23"
      height="18"
...
export const MenuSvg: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <svg
      width="19"
      height="20"
